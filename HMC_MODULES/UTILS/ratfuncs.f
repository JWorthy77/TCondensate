...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      subroutine setEPolyRFCoeffs(SRF,func,ol,ou,r1,r2)
      use pfmodule
      use extpolyapproxmod
      use polycoeffsmod
      implicit none
      type(sgnratfunc),intent(out) :: SRF
      integer,intent(in) :: func,ol,ou
      real(prc),intent(in) :: r1,r2 

      call deallocSGNType(SRF)
      SRF%epoly%ol=ol
      SRF%epoly%ou=ou
      call getExtPolyCoeffs(func,ol,ou,r1,r2,SRF%epoly%cfs)
c      print *,SRF%epoly%cfs

      return
      end subroutine setEPolyRFCoeffs
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      subroutine setRemezCoeffs(SRF,func,op,oq,r1,r2)
      use pfmodule
      use remezapproxmod
      use polycoeffsmod
      implicit none
      type(sgnratfunc),intent(out) :: SRF
      integer,intent(in) :: func,op,oq
      real(prc),intent(in) :: r1,r2 
      real(prc) front
      ...
      call getRemezCoeffs(func,op,oq,r1,r2,front,SRF%spf%num,
     &                                           SRF%spf%denom)
      end associate
      return
      end subroutine setRemezCoeffs
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
