      ...
      use numbers
      implicit none
      logical,parameter :: VBS=.true.

      type zolotarev
!       x=x/zolo%xmin
!       zsgn=2*zolo%lambda/(one+zolo%lambda)*(x/zolo%M)*Rsgn(x*x,zolo)
        integer N
        real(zprc) xmin,xmax
        real(zprc) k
        real(zprc) kdash
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      do l=0,zolo%N/2-1
        ...
        if(VBS)then ; print *,"argC:",argC ; endif
        call jelp(argC,zolo%kdash,JargC, ecn, edn, eph )
        if(VBS)then ; print *,"JargC:",JargC ; endif
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      do j=1,Nz
        ...
        write(10,*) x,Sest,Sest-one,SestRT,SestRT-one
        x=x+dx
        xdash=xdash+dx
        x=lmin*exp(xdash)
      end do
